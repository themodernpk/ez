...
class EaseProfessionLevelController extends BaseController
{
    public $data;
    public $settings;
    ...
    public function __construct()
    {
        ...
        $this->settings = EaseProfessionLevel::getSettings();
    ...
    function index()
    {
        ...
        return View::make($this->data->view . 'index')->with('title', 'Profession Level List')->with('data', $this->data);
    }
