...
class EaseSeeker extends Eloquent
{
    ...
    public static $prefix = 'ease-seeker';
    public static $table_name = 'ease_seekers';
    public static $model = 'EaseSeeker';
    public static $view = 'ease::seeker.';
    ...
    public function ease_payments() {
        return $this->hasMany('App\EasePayment');
    }
    //------------------------------------------------------------
    //------------------------------------------------------------
    public function ease_user() {
        return $this->belongsTo('App\EaseUser');
    }
    //------------------------------------------------------------
    ...
    public static function getOnly(){
        //to check if firld exisg incolumn
    }
    //------------------------------------------------------------
    //------------------------------------------------------------
    //------------------------------------------------------------
