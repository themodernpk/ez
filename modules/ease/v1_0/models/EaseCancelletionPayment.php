...
class EaseCancelletionPayment extends Eloquent
{
    ...
    public function payment_by() {
        return $this->belongsTo('App\EaseUser','payment_by','_id');
    }
    //------------------------------------------------------------
    //------------------------------------------------------------
    public function payment_to() {
        return $this->belongsTo('App\EaseProvider','payment_to','_id');
    }
    //------------------------------------------------------------
    //------------------------------------------------------------
    public function ease_service_request_id() {
        return $this->belongsTo('App\EaseServiceRequest','ease_service_request_id','_id');
    }
    //------------------------------------------------------------
