...
class EaseUserVerification extends Eloquent
{
    ...
    public static $prefix = 'user-verification';
    public static $table_name = 'ease_user_verifications';
    public static $model = 'EaseUserVerification';
    public static $view = 'ease::userverification.';
