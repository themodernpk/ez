...
class EaseReportIssue extends Eloquent
{
    ...
    public static $prefix = 'ease-report-issue';
    public static $table_name = 'ease_report_issues';
    public static $model = 'EaseReportIssue';
    public static $view = 'ease::report-issue.';
