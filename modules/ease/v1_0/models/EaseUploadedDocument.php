...
class EaseUploadedDocument extends Eloquent
{
    ...
    public static $prefix = 'ease-uploaded-document';
    public static $table_name = 'ease_uploaded_documents';
    public static $model = 'EaseUploadedDocument';
    public static $view = 'ease::uploadeddocument.';
    ...
    {
        return $this->belongsTo('EaseUser','id','ease_user_id');
    }
    //------------------------------------------------------------
