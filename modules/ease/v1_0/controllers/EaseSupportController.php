...
class EaseSupportController extends BaseController
{
    public $data;
    public $settings;
    ...
    public function __construct()
    {
        ...
        $this->settings = EaseSupport::getSettings();
    ...
    function index()
    {
        ...
        return View::make($this->data->view . 'index')->with('title', 'Support List')->with('data', $this->data);
    }
