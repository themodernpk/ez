...
class EaseSupport extends Eloquent
{
    ...
    public static $prefix = 'ease-support';
    public static $table_name = 'ease_supports';
    public static $model = 'EaseSupport';
    public static $view = 'ease::support.';
