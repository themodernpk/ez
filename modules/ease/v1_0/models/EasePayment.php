...
class EasePayment extends Eloquent
{
    ...
    public static $prefix = 'ease-payment';
    public static $table_name = 'ease_payments';
    public static $model = 'EasePayment';
    public static $view = 'ease::payment.';
    ...
    public function payment_by() {
        return $this->belongsTo('App\EaseUser','id','payment_by');
    }
    //------------------------------------------------------------
    //------------------------------------------------------------
    public function payment_to() {
        return $this->belongsTo('App\EaseProvider','id','payment_to');
    }
    //------------------------------------------------------------
    //------------------------------------------------------------
    public function ease_service_request_id() {
        return $this->belongsTo('App\EaseServiceRequest','id','ease_service_request_id');
    }
    //------------------------------------------------------------
