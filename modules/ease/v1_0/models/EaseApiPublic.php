...
class EaseApiPublic extends Eloquent
{
    ...
    public static $prefix = 'ease-api-public';
    public static $table_name = 'ease_api_publics';
    public static $model = 'EaseApiPublic';
    public static $view = 'ease::ease_api_public.';
