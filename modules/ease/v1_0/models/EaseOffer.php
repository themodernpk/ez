...
class EaseOffer extends Eloquent
{
    ...
    public static $prefix = 'ease-offer';
    public static $table_name = 'ease_offers';
    public static $model = 'EaseOffer';
    public static $view = 'ease::offer.';
