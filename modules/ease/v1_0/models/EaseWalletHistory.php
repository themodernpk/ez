...
class EaseWalletHistory extends Eloquent
{
    ...
    public static $prefix = 'ease-tnc';
    public static $table_name = 'ease_tncs';
    public static $model = 'EaseTnc';
    public static $view = 'ease::tnc.';
