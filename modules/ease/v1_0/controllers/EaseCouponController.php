...
class EaseCouponController extends BaseController
{
    public $data;
    public $settings;
    ...
    public function __construct()
    {
        ...
        $this->settings = EaseCoupon::getSettings();
    ...
    function index()
    {
        ...
        return View::make($this->data->view . 'index')->with('title', 'Coupon List')->with('data', $this->data);
    }
