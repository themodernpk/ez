...
@section('page_specific_head')
    ...
    <link href="<?php echo asset_path(); ?>/plugins/bootstrap3-datetimepicker/datetimepicker.css" rel="stylesheet"/>
@stop
...
@section('page_specific_foot')
    ...
    <script src="<?php echo asset_path(); ?>/plugins/bootstrap3-datetimepicker/moment-with-locales.js"></script>
    <script src="<?php echo asset_path(); ?>/plugins/bootstrap3-datetimepicker/bootstrap-datetimepicker.js"></script>
    ...
    <script src="<?php echo asset_path('ease'); ?>/coupon.js"></script>
@stop