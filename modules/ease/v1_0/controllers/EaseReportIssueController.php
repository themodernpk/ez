...
class EaseReportIssueController extends BaseController
{
    public $data;
    public $settings;
    ...
    public function __construct()
    {
        ...
        $this->settings = EaseReportIssue::getSettings();
    ...
    function index()
    {
        ...
        return View::make($this->data->view . 'index')->with('title', 'Report Issue List')->with('data', $this->data);
    }
