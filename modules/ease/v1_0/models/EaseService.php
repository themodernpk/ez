...
class EaseService extends Eloquent
{
    ...
    public static $prefix = 'ease-service';
    public static $table_name = 'ease_services';
    public static $model = 'EaseService';
    public static $view = 'ease::service.';
