...
class EaseCommissionPayment extends Eloquent
{
    ...
    public static $view = 'ease::service_payment.';
    ...
    public static function create_rules()
    {
        return [
            ...
            'ease_service_request_id' => 'required'
        ];
    }
    //------------------------------------------------------------
    public function ease_provider() {
        return $this->belongsTo('App\EaseProvider','ease_provider_id','_id');
    }
    //------------------------------------------------------------
    public function ease_service_request_id() {
        return $this->belongsTo('App\EaseServiceRequest','_id','ease_service_request_id');
    }
    //------------------------------------------------------------
