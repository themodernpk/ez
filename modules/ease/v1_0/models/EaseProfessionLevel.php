...
class EaseProfessionLevel extends Eloquent
{
    ...
    public static $prefix = 'ease-profession-level';
    public static $table_name = 'ease_profession_levels';
    public static $model = 'EaseProfessionLevel';
    public static $view = 'ease::profession-level.';
    ...
    public function ease_service_requests() {
        return $this->hasMany('EaseService','_id','profession_level_id');
    }
    //------------------------------------------------------------
