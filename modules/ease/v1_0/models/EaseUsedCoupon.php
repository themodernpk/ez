...
class EaseUsedCoupon extends Eloquent
{
    ...
    public static $prefix = 'ease-coupon';
    public static $table_name = 'ease_coupons';
    public static $model = 'EaseUsedCoupon';
    public static $view = 'ease::coupon.';
    ...
    //------------------------------------------------------------
    public function ease_coupon() {
        return $this->belongsTo('App\EaseCoupon');
    }
    //------------------------------------------------------------
    ...
    public static function store($input = NULL)
    {
        ...
        foreach ($columns as $key) {
            if (array_key_exists($key, $input_array)) {
                ...
                isset($input_array['discount_type'])
                && isset($input_array['discount_value']
                )){
                $discount_input=array();
                $discount_input['discount_type']=$input_array['discount_type'];
                $discount_input['discount_value']=$input_array['discount_value'];

                $item->$key = json_encode($discount_input);
            }
        }
        try {
            $item->save();
