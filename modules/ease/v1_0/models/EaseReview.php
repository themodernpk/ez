...
class EaseReview extends Eloquent
{
    ...
    public static $prefix = 'ease-review';
    public static $table_name = 'ease_reviews';
    public static $model = 'EaseReview';
    public static $view = 'ease::review.';
    ...
    //------------------------------------------------------------
    public function ease_seeker() {
        return $this->belongsTo('App\EaseSeeker','review_by','_id');
    }
    //------------------------------------------------------------
    //------------------------------------------------------------
    public function ease_user() {
        return $this->belongsTo('App\EaseUser','review_to','_id');
    }
    //------------------------------------------------------------
    //------------------------------------------------------------
    public function ease_service_request() {
        return $this->belongsTo('App\EaseServiceRequest');
    }
    //------------------------------------------------------------
    //------------------------------------------------------------
