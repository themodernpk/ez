...
class EaseReviewController extends BaseController
{
    public $data;
    public $settings;
    ...
    public function __construct()
    {
        ...
        $this->settings = EaseReview::getSettings();
    ...
    function index()
    {
        ...
        return View::make($this->data->view . 'index')->with('title', 'Review List')->with('data', $this->data);
    }
