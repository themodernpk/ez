...
class EaseServicePayment extends Eloquent
{
    ...
    public static $prefix = 'ease-service-payment';
    public static $table_name = 'ease_service_payments';
    public static $model = 'EaseServicePayment';
    public static $view = 'ease::payment.service.';
    ...
    {
        return [
            'ease_seeker_id' => 'required',
            'ease_provider_id' => 'required',
    ...
    public function payment_by() {
        return $this->belongsTo('EaseUser','payment_by','_id');
    }
    //------------------------------------------------------------
    //------------------------------------------------------------
    public function payment_to() {
        return $this->belongsTo('EaseProvider','payment_to','_id');
    }
    //------------------------------------------------------------
    //------------------------------------------------------------
    public function ease_service_request_id() {
        return $this->belongsTo('EaseServiceRequest','ease_service_request_id','_id');
    }
    //------------------------------------------------------------
